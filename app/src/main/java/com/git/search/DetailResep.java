...
public class DetailResep extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String url_detail 	= Server.URL + "detail_resep.php";
    ...
    private void callDetail(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailResep.this,
